...
from modules.model import preprocess_true_boxes, yolo_body, tiny_yolo_body, yolo_loss
from modules.yolo3_utils import get_random_data
from configuration import configuration as data_config


def train():
    annotation_path = data_config.annotation_path
    class_names = get_classes(data_config.classes_file_path)
