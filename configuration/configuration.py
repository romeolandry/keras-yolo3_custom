...
Name_dataset = "Custom_data_5" # Name of your folder Dataset e.g Custom_data_[calsse_names]
classe = ['Bagel'] # Witch Classes will be Downloaded to see availabel classe ['Apple','Orange']
